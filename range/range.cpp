...
ExampleWindow::ExampleWindow():
  ...
  m_Check_Button("Display value on scale widgets", 0),
  ...
  //CheckButton:
  m_Check_Button.set_active();
  m_Check_Button.signal_toggled().connect( sigc::mem_fun(*this,
    &ExampleWindow::on_check_button_toggled) );
  m_VBox2.pack_start(m_Check_Button, Gtk::PACK_SHRINK);
...
void ExampleWindow::on_check_button_toggled() {
  m_VScale.set_draw_value(m_Check_Button.get_active());
  m_HScale.set_draw_value(m_Check_Button.get_active());
}
